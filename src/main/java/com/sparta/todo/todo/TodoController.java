...
import com.sparta.todo.todo.TodoListResponseDTO;
...
public class TodoController {
    ...
    @PostMapping
    public ResponseEntity<TodoResponseDTO> postTodo(@RequestBody com.sparta.todo.todo.TodoRequestDTO todoRequestDTO, @AuthenticationPrincipal UserDetailsImpl userDetails) {
    ...
    @PutMapping("/{todoId}")
    public ResponseEntity<TodoResponseDTO> putTodo(@PathVariable Long todoId, @RequestBody com.sparta.todo.todo.TodoRequestDTO todoRequestDTO, @AuthenticationPrincipal UserDetailsImpl userDetails) {
        try {
